...
//        val videoPlayUrl = "/storage/emulated/0/download/VID_20181025.mp4"
        ...
        // true表示ExoPlayer，false表示MediaPlayer
        const val USE_EXOPLAYER = true

        // 对于长视频, 每隔3s截取一个缩略图
        const val MAX_FRAME_INTERVAL_MS = 3 * 1000

        // 默认显示10个缩略图
        const val DEFAULT_FRAME_COUNT = 10

        // 裁剪最小时间为3s
        const val minSelection = 3000 // 最短3s

        // 裁剪最长时间为30s
        const val maxSelection: Long = 30000 // 最长30s
    }
}